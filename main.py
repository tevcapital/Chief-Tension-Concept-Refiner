...
from agents import concept_agent, tension_agent, chief_pick_agent, refiner_agent
...
def run(brief: str):
    ...
    log("CHIEF", f"Domain: {brief}")

    # Step 1: Generate 3 use cases
    log("CONCEPT AGENT", f"Generating 3 OpenClaw use cases for: {brief}...")
    ideas = concept_agent(brief, config)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print('Example: python main.py healthcare')
        print('Example: python main.py "solo entrepreneurs"')
        sys.exit(1)
